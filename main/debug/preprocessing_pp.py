if __name__ == "__main__":
    ...
    pp_data = PP("/Users/dogawa/PycharmProjects/GANs/debug/data/pp_ped.csv", nw_data)
    ...
    pp_data.write_geo_file("/Users/dogawa/PycharmProjects/GANs/debug/data/pp_ped.geojson", driver="GeoJSON")